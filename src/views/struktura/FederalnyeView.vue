...
<template>
    <Page title="Федеральные проекты">
        <Title>Федеральные проекты</Title>
        
        <Text align="left">
            • <Link linkTo="/structure/korpus_obschestvennyh_nablyudateley">Корпус общественных наблюдателей</Link><br/>
